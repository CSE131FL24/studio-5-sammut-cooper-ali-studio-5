...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		Color bluering = new Color(0, 109, 219);
		StdDraw.setPenColor(bluering);
		StdDraw.filledCircle(x,  y,  (.75 * radius));
		

		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		Color redring = new Color(146, 0, 0);
		StdDraw.setPenColor(redring);
		StdDraw.filledCircle(x,  y,  (.5 * radius));
		

		// Yellow ring with 1.0/4.0 the radius
		// suggested rgb values: 255, 255, 109
		Color yellowring = new Color(255, 255, 109);
		StdDraw.setPenColor(yellowring);
